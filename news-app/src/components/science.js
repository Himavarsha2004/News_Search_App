...
const Science= () => {
  ...
  const fetchScienceNewsQuery = async (query) => {
    try {
  ...
  return (
    <div className="science-page" style={{ backgroundColor: 'rgb(33, 55, 100)', minHeight: '100vh' }}>
      <header>
        <nav className="navbar">
          <div className="logo">Science News.</div>
